...
const thaiUiDictionary: Record<string, string> = {
  ...
  // Google-Forms-style item toolbar and the section/text blocks it inserts.
  "Untitled evaluation form": "แบบประเมินที่ยังไม่มีชื่อ",
  "Description": "คำอธิบาย",
  "Title": "หัวข้อ",
  "No questions to try yet": "ยังไม่มีคำถามให้ทดลองตอบ",
  "No questions to preview yet": "ยังไม่มีคำถามให้แสดงตัวอย่าง",
  "Add at least one question before publishing.": "ต้องมีคำถามอย่างน้อย 1 ข้อก่อนเผยแพร่",
  "A published evaluation needs at least one required question.": "แบบประเมินที่เผยแพร่ต้องมีคำถามบังคับอย่างน้อย 1 ข้อ",
  "Add section": "เพิ่มส่วน",
  "Try it as a learner": "ทดลองตอบแบบผู้เรียน",
  "Add text": "เพิ่มข้อความ",
  "Add form item": "เพิ่มรายการในแบบฟอร์ม",
  "Section title": "ชื่อส่วน",
  "After this section": "หลังส่วนนี้",
  "Continue to next section": "ไปยังส่วนถัดไป",
  "Untitled section": "ส่วนที่ไม่มีชื่อ",
  "Untitled text": "ข้อความที่ไม่มีชื่อ",
  ...
  // --- Function & Organization Data / Function Mapping (added 2026-08-17) ---
  ACTIVE: "ใช้งาน",
  INACTIVE: "ไม่ใช้งาน",
  Departments: "ส่วน",
  Divisions: "ฝ่าย",
  Sections: "แผนก",
  Division: "ฝ่าย",
  "Function and Organization Data module": "โมดูลข้อมูลหน่วยงานและโครงสร้างองค์กร",
  "Function, Division, Department & Section": "หน่วยงาน ฝ่าย ส่วน และแผนก",
  "No matching records.": "ไม่พบข้อมูลที่ตรงกัน",
  None: "ไม่มี",
  "Organization Structure": "โครงสร้างองค์กร",
  "Search Function, Division, Department, or Section":
    "ค้นหาหน่วยงาน ฝ่าย ส่วน หรือแผนก",
  "Search function, division, department, or section":
    "ค้นหาหน่วยงาน ฝ่าย ส่วน หรือแผนก",
  "Mapping Records": "รายการเชื่อมโยง",
  "Maps to": "เชื่อมโยงไปยัง",
  "Plant Code": "รหัสเฉพาะบริษัท",
  "Plant Name": "ชื่อเฉพาะบริษัท",
  "Scoped Master": "ข้อมูลหลักตามสิทธิ์",
  "Search company, level, plant code, or master name":
  ...
  "Share of attendees who have answered the pre-test.": "สัดส่วนผู้เข้าอบรมที่ทำแบบทดสอบก่อนอบรมแล้ว",
  "Share of attendees who have answered the post-test.": "สัดส่วนผู้เข้าอบรมที่ทำแบบทดสอบหลังอบรมแล้ว",
