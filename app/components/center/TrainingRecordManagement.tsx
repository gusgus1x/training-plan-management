...
const evaluationCompanies: Record<ActualTrainingKey, EvaluationCompany[]> = {
  "actual-001": [
    ...
    { company: "TEP", employees: [
      { id: "EMP-105", name: "Kamon S.", department: "Production", contentScore: 4, trainerScore: 4, applicationScore: 5, comment: "เนื้อหาเหมาะสม" },
    ] },
  ],
  "actual-002": [
    { company: "ATFB", employees: [
