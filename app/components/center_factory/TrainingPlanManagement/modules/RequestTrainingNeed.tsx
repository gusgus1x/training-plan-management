...
export const requestTrainingNeedModule = {
  ...
  subtitle: "คำขออบรม",
  description: "รับและตรวจสอบคำขออบรมจากหน่วยงานก่อนนำเข้าสู่แผนอบรม",
} as const;

const initialRows = [["REQ-001","Data Privacy Awareness","IT Governance","36 users","Waiting HRD"],["REQ-002","Advanced Excel","Planning","18 users","Accepted"],["REQ-003","Safety Refresh","Maintenance","28 users","Review"]] as const;
const formFields = ["Request no.","Course need","Request by","Approved by"] as const;
  ...
  return (
    <section className={styles.moduleWorkspace} aria-label={`Request Training Need module`}>
      ...
      <section className={styles.formPanel}>
        ...
        <p>This form lives in the {requestTrainingNeedModule.title} module file, so page-specific logic can be edited here.</p>
