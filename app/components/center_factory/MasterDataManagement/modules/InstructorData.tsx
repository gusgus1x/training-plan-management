...
export const instructorDataModule = {
  ...
  subtitle: "ข้อมูลวิทยากร",
  description: "จัดการข้อมูลวิทยากรภายในและภายนอกสำหรับใช้ในหลักสูตรอบรม",
} as const;

const initialRows = [["INS-001","Somchai P.","Internal","Leadership","Active"],["INS-002","Safety Team","Internal","Safety","Active"],["INS-003","External Partner","External","Digital","Review"]] as const;
const formFields = ["Instructor code","Instructor name","Type","Specialty"] as const;
  ...
  return (
    <section className={styles.moduleWorkspace} aria-label={`Instructor Data module`}>
      ...
      <section className={styles.formPanel}>
        ...
        <p>This form lives in the {instructorDataModule.title} module file, so page-specific logic can be edited here.</p>
