...
export const employeeDataModule = {
  ...
  description: "จัดการข้อมูลพนักงาน บริษัท หน่วยงาน ตำแหน่ง และสถานะการทำงาน",
} as const;

const initialRows = [["EMP-001","Somchai P.","ATFB / HRD","Supervisor","Active"],["EMP-014","Naree T.","SNF / MFG","Engineer","Active"],["EMP-022","Kanda S.","NIC / QA","Staff","Active"]] as const;
const formFields = ["Employee ID","Employee name","Company / Function","Position"] as const;
...
export default function EmployeeData() {
  ...
  return (
    <section className={styles.moduleWorkspace} aria-label={`Employee Data module`}>
      <section className={styles.moduleHero}>
        <div>
          <p className={styles.panelKicker}>{employeeDataModule.subtitle}</p>
      ...
      <section className={styles.formPanel}>
        ...
        <p>This form lives in the {employeeDataModule.title} module file, so page-specific logic can be edited here.</p>
