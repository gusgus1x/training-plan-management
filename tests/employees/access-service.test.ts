...
const principal=(role:RoleCode,companyId:string|null,employeeId:string|null=null):AuthenticatedPrincipal=>({userId:"9",username:"test",role,companyId,employeeId,email:null,employeeCode:null,displayName:null,companyCode:null,companyName:null,functionCode:null,functionName:null,positionCode:null,positionName:null,levelCode:null,levelName:null,pl:null});
