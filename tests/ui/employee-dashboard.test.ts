...
describe("30-day follow-up evaluation reminder", () => {
  ...
  it("does not flag one that has already been submitted", () => {
    const enrollment = enrollmentWithFollowUp({
      submission: { submissionId: "9001", attemptNo: 1, submittedAt: "2026-06-10T00:00:00.000Z", score: null, scoreMax: 10, passStatus: "PENDING", gradingStatus: "REVIEWED", resultsPublished: true }, attempts: [{ submissionId: "9001", attemptNo: 1, submittedAt: "2026-06-10T00:00:00.000Z", score: null, scoreMax: 10, passStatus: "PENDING", gradingStatus: "REVIEWED", resultsPublished: true }], totalScore: 10
    });
