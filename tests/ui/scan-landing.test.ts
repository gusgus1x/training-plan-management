...
describe("resolveScanDestination", () => {
  ...
  it("still forwards someone who already submitted - the runner tells them, and a retake is allowed", () => {
    const submitted = stage({
      submission: { submissionId: "9001", attemptNo: 1, submittedAt: "2026-09-02T00:00:00.000Z", score: 90, scoreMax: 10, passStatus: "PASS", gradingStatus: "REVIEWED", resultsPublished: true }, attempts: [{ submissionId: "9001", attemptNo: 1, submittedAt: "2026-09-02T00:00:00.000Z", score: 90, scoreMax: 10, passStatus: "PASS", gradingStatus: "REVIEWED", resultsPublished: true }], totalScore: 10
    });
