...
console.log('Sample record 150:', records[150]);
console.log('Sample record 285:', records[285]);

// Count per company code
const counts = {};
records.forEach(r => {
  counts[r.compCode] = (counts[r.compCode] || 0) + 1;
});
console.log('Counts per company:', counts);
