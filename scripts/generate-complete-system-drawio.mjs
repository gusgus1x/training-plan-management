...
builder.addStandardPage(
  ...
  "แบบประเมินมาตรฐานและแบบประเมิน 19 ข้อ ➔ แบ่งหน้า/เงื่อนไข ➔ คำนวณความพึงพอใจ ➔ ส่งออกรายงาน",
  [
    ...
    {
      type: "process",
      text: "1. ออกแบบข้อคำถามในแบบฟอร์ม (2 รูปแบบ)\n• แบบประเมินทั่วไป: ดาว 1-5, ตัวเลือก, ตารางหัวข้อย่อย และข้อเสนอแนะ\n• แบบประเมินองค์กร 19 ข้อ: Part 1 ทั่วไป, Part 2 หลักสูตร, Part 3 วิทยากร, Part 4 ข้อคิดเห็น",
      height: 95,
      style: STYLES.blue,
      edgeColor: "#2563eb"
    },
    ...
    {
      type: "process",
      text: "4. เปิดใช้งานแบบประเมิน และผูกเข้ากับรอบอบรม\nเปิดให้พนักงานที่เข้าอบรมทำแบบประเมินหลังเรียนจบผ่านหน้าเว็บหรือสแกน QR Code",
      style: STYLES.green,
      edgeColor: "#16a34a"
    },
    {
      type: "process",
      text: "5. ประมวลผลคะแนน & แปลงผลประเมิน (Section Converter)\nคำนวณร้อยละความพึงพอใจภาพรวม พร้อมรวบรวมข้อคิดเห็น Part 4 ส่งต่อผู้เกี่ยวข้อง",
      height: 85,
      style: STYLES.purple,
      edgeColor: "#7c3aed"
    },
    {
      type: "document",
      text: "ส่งออกรายงานสรุปผลประเมิน (Evaluation Report Excel)\nรายงานสรุปคะแนนความพึงพอใจ จำแนกตามหมวด และรายงานข้อคิดเห็นส่งผู้บริหาร",
    },
    { type: "terminator", text: "สิ้นสุด (End)" }
  ],
  [
...
builder.addStandardPage(
  "10. Plan - Training Accept Survey",
  "Training Accept Survey: สำรวจโควตา คัดกรอง และอนุมัติผู้เข้าอบรม",
  "คัดกรองด้วย Multi-Filter Toolbar ➔ เช็คประวัติอบรมซ้ำ (Retake) ➔ จัดสรรโควตาโรงงาน ➔ อนุมัติและส่งแจ้งเตือน",
  [
    { type: "terminator", text: "เริ่มสำรวจผู้เข้าอบรม (Start)" },
    {
      type: "process",
      text: "1. คัดกรองกลุ่มเป้าหมายด้วย Multi-Filter Toolbar\n• กรองแผนก (Department Filter Dropdown): คัดกรองเฉพาะสังกัดที่ต้องการ\n• กรองประวัติ/สถานะ (Status Dropdown): เคยผ่านการอบรม, ยังไม่เคยอบรม, รออนุมัติ, อนุมัติแล้ว, ร่าง\n• ช่องค้นหาด่วน (Search Box): ค้นหาด้วยชื่อพนักงาน (ไทย/อังกฤษ) หรือรหัสพนักงาน (Emp ID)",
      height: 95,
      style: STYLES.purple,
      edgeColor: "#7c3aed"
    },
    {
      type: "decision",
      text: "พนักงานเคยผ่าน\nคอร์สนี้แล้วหรือไม่?",
      yesLabel: "ยังไม่เคยผ่าน (New Learner)"
    },
    {
      type: "process",
      text: "2. จัดสรรโควตาโรงงานและเสนอชื่อ (Nomination)\nโรงงาน (ATA, TEP, ATFB, etc.) เสนอชื่อผู้เข้าอบรมตามโควตาที่จัดสรร พร้อมจัดเก็บฉบับร่าง (Draft)",
      height: 80,
      style: STYLES.blue,
      edgeColor: "#2563eb"
    },
    ...
    {
      type: "process",
      text: "3. ยืนยันรายชื่อ & ส่งแจ้งเตือน (Notifications Dispatch)\nบันทึกรายชื่อผู้มีสิทธิ์เข้าอบรมจริง พร้อมส่งการแจ้งเตือนอัตโนมัติไปยังกระดิ่งแจ้งเตือน (Notification Bell) และแดชบอร์ดพนักงาน",
      height: 85,
      style: STYLES.green,
      edgeColor: "#16a34a"
    },
    {
      type: "document",
      text: "ส่งออกใบเช็คชื่อผู้เข้าเรียน (Attendance Sheet Excel)\nเอกสารใบลงชื่ออย่างเป็นทางการสำหรับใช้เช็คชื่อในวันจัดอบรมจริง พร้อมส่งต่อให้อาจารย์ผู้สอน",
    },
    { type: "terminator", text: "สิ้นสุด (End)" }
  ],
  [
    {
      ...
      text: "เคยผ่านคอร์สนี้แล้ว (Retake Detected):\nระบบแสดง Badge เตือนว่าเคยผ่านการอบรมแล้ว พร้อมระบุรอบ/ปีเดิม เพื่อให้พิจารณาความจำเป็นก่อนส่งเรียนซ้ำ",
      label: "เคยผ่านแล้ว (Retake)",
      style: STYLES.amber,
      edgeColor: "#d97706",
      width: 330,
      height: 85
    },
    {
      ...
      text: "ไม่อนุมัติ / เกินโควตา:\nปรับสถานะเป็นรอคิว (Waitlist) หรือไม่อนุมัติ พร้อมบันทึกเหตุผลแจ้งกลับไปยังโรงงานต้นสังกัด",
...
builder.addStandardPage(
  ...
  [
    ...
    {
      type: "process",
      text: "2. รวมคะแนนสอบและผลประเมินความพึงพอใจ\nคำนวณคะแนนก่อน-หลังเรียน (% พัฒนาการ) ➔ รวมคะแนนแบบประเมิน 19 ข้อ & ข้อคิดเห็น ➔ ตัดเกรด ผ่าน/ไม่ผ่าน",
      height: 85,
      style: STYLES.purple,
      edgeColor: "#7c3aed"
    },
...
builder.addStandardPage(
  ...
  [
    ...
    {
      type: "process",
      text: "1. เข้าสู่หน้าหลักพนักงาน (User Dashboard)\nดูสถานะการอบรม, ศูนย์แจ้งเตือนกลาง (Notification Center & Bell), คอร์สที่เปิดรับ, และข่าวสารกิจกรรม",
      height: 85,
      style: STYLES.blue,
      edgeColor: "#2563eb"
    },
